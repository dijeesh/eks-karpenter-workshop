locals {
  cluster_name                                          = "acme-karpenter-us-east-1"
  cluster_version                                       = "1.21"
  eks_cluster_iam_role                                  = "iam-role-acme-karpenter-eks-cluster"
  eks_cluster_node_role                                 = "iam-role-acme-karpenter-eks-cluster-nodes"
  eks_cluster_eks_cni_role                              = "iam-role-acme-karpenter-eks-cni"
  eks_cluster_autoscaler_role                           = "iam-role-acme-karpenter-eks-cluster-autoscaler"
  eks_cluster_loadbalancer_controller_role              = "iam-role-acme-karpenter-eks-cluster-lb-controller"
  eks_cluster_loadbalancer_controller_policy            = "iam-policy-acme-karpenter-eks-cluster-lb-controller"
  eks_cluster_loadbalancer_controller_additional_policy = "iam-policy-acme-karpenter-eks-cluster-lb-controller-additional"
  eks_managed_worker_nodes_name                         = "workernodes-acme-karpenter-us-east-1"
  ...
  KarpenterControllerRole                               = "KarpenterControllerRole-acme-karpenter-us-east-1"
  KarpenterControllerPolicy                             = "KarpenterControllerPolicy-acme-karpenter-us-east-1"
  KarpenterNodeInstanceProfile                          = "KarpenterNodeInstanceProfile-acme-karpenter-us-east-1"
  KarpenterNodeRole                                     = "KarpenterNodeRole-acme-karpenter-us-east-1"
}
